...
describe file("#{file_name}/e/c/cxdel.int") do
  it { should be_file }
...
describe file("#{file_name}/e/t/dcna900.int") do
  it { should be_file }
...
describe file("#{file_name}/e/t/dcnaca90.int") do
  it { should be_file }
...
describe file("#{file_name}/e/t/dcnanax.int") do
  it { should be_file }
...
describe file("#{file_name}/e/t/dcnanay.int") do
  it { should be_file }
...
describe file("#{file_name}/e/t/tducna01.int") do
  it { should be_file }
...
describe file("#{file_name}/e/t/tducna02.int") do
  it { should be_file }
...
describe file("#{file_name}/e/t/tducnawr.int") do
  it { should be_file }
